...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'players.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/players.html'`` the file from the app1 package is loaded,
    by loading ``'app2/players.html'`` the file from the second.
    """
